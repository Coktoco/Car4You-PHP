<?php
    ...
    if(isset($_GET['ID_pojazd']) && ($_GET['ID_klient']))
...
<nav class="bg-gradient">
    ...
    <main class="vertical-center justify-content-center flex-column">
                ...
                <div class="pt-2 row pl-3 justify-content-between ">
                    ...
                    <form action="" method="post" class="mr-3">
                        <fieldset class="d-flex align-items-center">
                            <input class="mr-2" type="text" name="model" id="model" placeholder="Wpisz model">	         
                            <input type="submit" class="btn btn-primary margin-top" value="Szukaj"></input>
                        </fieldset>
                    </form> 
                </div>
            ...
            <div class="pt-2 row pl-3 justify-content-between ">
                    ...
                    <form action="" method="post" class="mr-3">
                        <fieldset class="d-flex align-items-center">
                            <input class="mr-2" type="text" name="model2" id="model2" placeholder="Wpisz model">	         
                            <input type="submit" class="btn btn-primary margin-top" value="Szukaj"></input>
                        </fieldset>
                    </form> 
                </div>
            ...
            <h3>Łodzie</h3>
                    <form action="" method="post" class="mr-3">
                        <fieldset class="d-flex align-items-center">
                            <input class="mr-2" type="text" name="model3" id="model3" placeholder="Wpisz model">	         
                            <input type="submit" class="btn btn-primary margin-top" value="Szukaj"></input>
                        </fieldset>
                    </form> 
                </div>
